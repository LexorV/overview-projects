...
export const MainPage = () => {
  return (
    <main className={styles.main}>
        ...
        <h2>Алоха, кодеры! Меня зовут Алексей!</h2>
        <div className={styles.text_box}>
        <p> Хочу попопасть к вам в команду!</p>
        <p> Немного о себе:</p>
        <p> Начну я, пожалуй, с того как начал свой путь. Ранее я работал инженером/системным администратором, в ходе работы часто сталкивался с web-приложениями(не сайтами).
        ...
        За всё время работал сначала на VanillaJS, потом на React, потом на Node.js, а сейчас пишу с помощью Vue.js 
        (решил перепробовать максимум фреймворков). Во всех проектах используются HTML5, CSS3 (что наверное логично). 
        ...
        <p> Ищу команду опытных разработчиков для создания востребованных сервисов, а также повышения собственной квалификации.</p>
        </div>
